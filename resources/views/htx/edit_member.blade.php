@extends('htx_layout')
@section('title', 'Chỉnh sửa Thành Viên HTX')
@section('HTX_content')
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-bordered striped-rows" action="{{URL::to('edit_member')}}" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{$nd->id}}">
                 ...
                 <button type="submit" class="btn btn-success waves-effect waves-light"><i class="fa fa-check-square-o"></i> Sửa thành viên</button>
                   </div>
