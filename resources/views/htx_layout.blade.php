                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            ...
                            <p class="designation m-0">Chủ Nhiệm</p>
                        </div>
                    </div>
                    <ul class="sidebar-menu">
                      ...
                      <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          <li><a href="{{URL::to('add_member')}}"><i class="fa fa-circle-o"></i> Thêm thành viên</a></li>
                          <li><a href="{{URL::to('ds_member')}}"><i class="fa fa-circle-o"></i> Danh sách thành viên</a></li>
                        </ul>
                      </li>
                      <li class="treeview">
                        <a href="#" class="waves-effect">
                        ...
                        <ul class="treeview-menu">
                          <li><a href="{{ URL::to('htx_ncc_vattu') }}"><i class="fa fa-circle-o"></i> NCC Vật Tư</a></li>
                          <li><a href="{{ URL::to('htx_loai_vattu') }}"><i class="fa fa-circle-o"></i> Loại Vật Tư</a></li>
                          <li><a href="{{ URL::to('htx_vattu') }}"><i class="fa fa-circle-o"></i> Danh Sách Vật Tư</a></li>
